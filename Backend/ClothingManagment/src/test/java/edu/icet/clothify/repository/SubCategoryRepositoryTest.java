...
import edu.icet.clothify.config.SubCategoryServiceException;
...
public class SubCategoryRepositoryTest {
   ...
   class DeleteSubCategory {
        ...
        public void SubCategoryRepository_DeleteSubCategory_ReturnVoid() throws SubCategoryServiceException {
            //Given
            SubCategory subCategory = SubCategory.builder().id(null).name("Womens").build();
            //When
            SubCategory savedSubCategory=subCategoryRepository.save(subCategory);
